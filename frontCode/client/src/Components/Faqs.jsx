const Faqs = () => {
  return (
    <div>
      <section className=" dark:text-gray-200" id="Faqs">
        <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
          <h2 className="text-2xl font-semibold sm:text-4xl text-[#00df9a]">
          ...
          <div className="space-y-4">
            <details className="w-full border  rounded-lg">
              <summary className="px-4 text-[#00df9a] py-6 focus:outline-none focus-visible:dark:ring-violet-600">
