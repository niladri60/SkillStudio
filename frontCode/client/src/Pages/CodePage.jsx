  ...
  const fetchCode = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5000/app/codingproblem"
      );
      ...
      <div className="text-white">
        {codeContent ? (
          <div>
            ...
            <p>
              <strong>Example:</strong> {codeContent.Example}
            </p>
            <p>
              <strong>Constraint:</strong> {codeContent.Constraint}
            </p>
            <p>
              <strong>Topic:</strong> {codeContent.Topic}
            </p>
            <p>
              <strong>Level:</strong> {codeContent.Level}
            </p>
          </div>
        ) : (
          <p>Loading...</p>
